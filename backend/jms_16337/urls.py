...
admin.site.site_header = "jms"
admin.site.site_title = "jms Admin Portal"
admin.site.index_title = "jms Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="jms API",
        default_version="v1",
        description="API documentation for jms App",
    ),
    public=True,
